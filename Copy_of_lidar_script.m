% select scene from "Simulation 3D Scene Configuration"
sceneName = 'Curvedroad';
[sceneImage, sceneRef] = helperGetSceneImage(sceneName);

% show 2D top-down view of scene
% hScene = figure;
...
% save both matrices to a MAT file for easy future access
% waypointsCurvedroad = struct('wayPoints',wayPoints,'refPoses',refPoses);
% save waypointsCurvedroad.mat waypointsCurvedroad
